...
@section('content')
    ...
    <div class="content-dashboard mt-10 ml-2"> 
      ...
      <div class="d-flex">
        <div class="row ml-1">
          <h2>
            <a href="/brand" class="btn btn-secondary btn-md mr-2" role="button"><i class="fa fa-arrow-left"></i></a>            
            {{$brand->nama_brand}}
          </h2>
        </div>
      ...
      <table class="table table-borderless table-striped table-hover table-dashboard">
        ...
        @foreach ($brand->produks as $key=>$produk)
            <tr class="align-self-center">
                ...
                <td class="row">
                    <a href="/produk/{{$produk->slug}}" class="text-decoration-none mx-2">
